(() => {
  ...
  const setCanvasImages = () => {
    ...
    for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
      imgElem = new Image();
      imgElem.src = `./video/003/IMG_${6726 + i}.jpeg`;
    ...
    switch (currentScene) {
      case 0:
        ...
        if (scrollRatio <= 0.22) {
          ...
          objs.messageA.style.transform = `translate3d(0, ${calcValues(values.messageA_translateY_out, currentYOffset)}%)`;
        }
        if (scrollRatio <= 0.42) {
          // in
      ...
      case 2:
        ...
        // currentScene 3에서 쓰는 캔버스 미리 그려주기 
        if (scrollRatio > 0.9) {
